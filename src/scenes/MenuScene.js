...
class MenuScene extends Phaser.Scene {
  ...
  _showHelp() {
    ...
    const body = [
      ...
      '',
      '5.  DEAD-EYE side bet.  Toggle ON to add 15% of your bet as a side',
      '     wager. Pays roughly N× if you nail the killer on the FIRST call',
      '     (2.85× at 3 suspects, 5.85× at 6). Lose it if you whiff or need',
      '     a second chance.',
      '',
